...
namespace FronkonGames.SpiceUp.Scanner
{
  ...
  {
    private static Scanner renderFeature;
    ...
    public static void AddRenderFeature()
    {
      if (IsInRenderFeatures() == false)
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          renderFeature = (Scanner)CreateInstance(typeof(Scanner).ToString());
      ...
      get
      {
        if (renderFeature == null)
        {
          ...
          if (pipelineAsset != null)
          {
            ...
            {
              if (scriptableRendererData.rendererFeatures[i] is Scanner)
                renderFeature = scriptableRendererData.rendererFeatures[i] as Scanner;
            }
          }
        }
